...
/***/ "./js/manager/healthPackManager.js":
/*!*****************************************!*\
  !*** ./js/manager/healthPackManager.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var phaser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! phaser */ \"phaser\");\n/* harmony import */ var phaser__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(phaser__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _objects_utilities_healthPack__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../objects/utilities/healthPack */ \"./js/objects/utilities/healthPack.js\");\n\r\n\r\n\r\nclass HealthPackManager {\r\n    constructor(scene) {\r\n        this.scene = scene;\r\n        this.healthPacks = scene.physics.add.group(); // Group to manage health packs\r\n        this.maxHealthPacks = 5; // Maximum number of health packs on screen at a time\r\n    }\r\n\r\n    createHealthPack() {\r\n        if (this.healthPacks.getChildren().length < this.maxHealthPacks) {\r\n            const healthPack = new _objects_utilities_healthPack__WEBPACK_IMPORTED_MODULE_1__[\"default\"](this.scene);\r\n            this.healthPacks.add(healthPack);\r\n        }\r\n    }\r\n\r\n    startDroppingHealthPacks() {\r\n        const randomDropTime = phaser__WEBPACK_IMPORTED_MODULE_0___default().Math.Between(5000, 10000); // Random interval between 5 to 10 seconds\r\n\r\n        this.dropHealthPack(); // Drop a health pack immediately when starting\r\n\r\n        this.dropTimer = this.scene.time.addEvent({\r\n            delay: randomDropTime,\r\n            loop: true,\r\n            callback: this.dropHealthPack,\r\n            callbackScope: this\r\n        });\r\n    }\r\n\r\n    dropHealthPack() {\r\n        if (this.healthPacks.getChildren().length < this.maxHealthPacks) {\r\n            const healthPack = new _objects_utilities_healthPack__WEBPACK_IMPORTED_MODULE_1__[\"default\"](this.scene);\r\n            this.healthPacks.add(healthPack);\r\n        }\r\n    }\r\n\r\n    // Other HealthPackManager methods...\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (HealthPackManager);\n\n//# sourceURL=webpack://src/./js/manager/healthPackManager.js?");
